<aside class="sidebar-l">
    <nav class="sidebar-wrapper">
        <ul class="sidebar-links">
            <a href="{{Auth::user() ? route('home') : route('welcome')}}" class="sidebar-link-container ">
            ...
            <a href="{{route('projects.index')}}" class="sidebar-link-container {{\Request::route()->getName() == 'projects' ? 'is-active' : ''}}">
                <li class="sidebar-link">
                    <img src="images/icons/portfolio-icon.svg" alt=""> <span class="sidebar-link-text"> {{__('Projets')}} </span> 
                </li>
            </a>
            <a href="{{route('users.index')}}" class="sidebar-link-container {{\Request::route()->getName() == 'school' ? 'is-active' : ''}}">
                <li class="sidebar-link">
